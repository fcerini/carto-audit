...
- Importar la base de vectores de calles (cuadras) en un servicio que permita buscar por direcciones o por Lat,Lon. Inicialmente se plantearon opciones como RAG o ElasticSearch.
...
- Calcular la direccion mediante la posicion del ELS (georreferenciacion inversa) con la base de vectores de calles y con Google. DireccionElsSoflex, DireccionElsGoogle
- Georreferenciar con Soflex y con Google
...
- DireccionElsGoogle, LatLon ELS
- DireccionElsSoflex,  LatLon ELS
